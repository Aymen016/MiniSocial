...
st.markdown(
    ...
    h1 {
        font-size: 25px; /* Adjust the font size for h1 headers */
    }
    button {
        color: purple; /* Change the color of button text */
    }
    </style>
    """,
...
def fetch_poster(movie_id):
     url = "https://api.themoviedb.org/3/movie/{}?api_key=45dccb9fe0788dbab3b9c8f6baa6b547".format(movie_id)
